...
function Index() {
  ...
  }, "Caching responses reduces the number of network requests that your app makes, speeding up its performance. Only make network calls when you absolutely need to.")), __jsx("div", {
    className: "heroPropContainer",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "bestfetch has great defaults that work for many apps. If something doesn't work for your use case, change it: with bestfetch's flexible API, you remain in control.")), __jsx("div", {
    className: "heroPropContainer",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "bestfetch is tiny but mighty. With its reasonable file size (~2.5kb gzipped) you can feel responsible adding it to an existing codebase.")))));
}

/***/ })

})
//# sourceMappingURL=index.js.63f3ecf7ce161c9a1bc1.hot-update.js.map