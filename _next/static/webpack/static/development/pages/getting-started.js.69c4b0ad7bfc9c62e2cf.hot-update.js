...
function GettingStarted() {
  ...
  }, "You're now ready to make a request! In the following example, two identical requests are made to fetch a todo item from an API."), __jsx("div", {
    className: "advanced",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "Heads up!"), " You can copy and paste these code snippets into your browser's developer tools to try them out!"), __jsx("code", {
    className: "codeBlock",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "What you're doing when you call ", __jsx("code", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 83,
  ...
  }, ".json()"), " is read the request body, parsing it as a JSON string. When you use bestfetch, the request body is read and parsed as JSON automatically for you."), __jsx("h2", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 87,
...
//# sourceMappingURL=getting-started.js.69c4b0ad7bfc9c62e2cf.hot-update.js.map