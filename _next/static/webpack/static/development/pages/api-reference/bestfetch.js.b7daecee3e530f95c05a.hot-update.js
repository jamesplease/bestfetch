...
function bestfetch() {
  ...
  }, "options"), ". An object that allows you to configure the request. The options are:", __jsx("ul", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16,
  ...
  }, "responseType"), " option of the request.")))), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
  ...
  }, "fetch"), ", refer to [the MDN documentation](https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch)."), __jsx("h2", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
...
//# sourceMappingURL=bestfetch.js.b7daecee3e530f95c05a.hot-update.js.map