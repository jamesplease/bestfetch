...
function CachingResponses() {
  ...
  }, "\"cache-first\""), ": The cache is checked first to see if a response already exists for the request. If a response is found, then it will be returned, and no network request will be made. If no response exists in the cache, then a network request will be made."), __jsx("li", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23,
...
//# sourceMappingURL=caching-responses.js.c9d002eb7d987efb2599.hot-update.js.map