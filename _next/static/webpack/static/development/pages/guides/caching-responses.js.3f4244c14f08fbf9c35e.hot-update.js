...
function CachingResponses() {
  ...
  }, "\"cache-first\""), ": Requests will first look at the cache to see if a response already exists for the request. If a response is found, then it will be returned, and no network request will be made. If no response exists in the cache, then a network request will be made."), __jsx("li", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
...
//# sourceMappingURL=caching-responses.js.3f4244c14f08fbf9c35e.hot-update.js.map