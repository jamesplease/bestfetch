...
function DeduplicatingRequests() {
  ...
  }, "If you only have one of these dropdowns on the page at a time, then there is no issue. But if you were to render two of these dropdowns at the same time, then they would each would make a request to fetch the same list of countries."), __jsx("p", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 75,
...
//# sourceMappingURL=deduplicating-requests.js.d456494001a26c468ab7.hot-update.js.map