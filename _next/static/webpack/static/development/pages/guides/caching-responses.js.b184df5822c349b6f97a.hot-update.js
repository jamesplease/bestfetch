...
function CachingResponses() {
  ...
  }, "\"cache-first\""), ": Requests will first look at the cache to see if a response exists for the request. If a response is found, then it will be returned, and no network request will be made. If no response exists in the cache, then a network request will be made."), __jsx("li", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23,
...
//# sourceMappingURL=caching-responses.js.b184df5822c349b6f97a.hot-update.js.map